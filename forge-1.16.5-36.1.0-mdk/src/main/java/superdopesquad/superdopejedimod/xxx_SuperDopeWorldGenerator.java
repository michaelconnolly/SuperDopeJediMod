...
//
//public class SuperDopeWorldGenerator {
//
//    public static void generateOreEventHandler(final BiomeLoadingEvent event) {
//
//        // Only spawn in normal world, i.e., not Nether and not TheEnd.
//        if (!(event.getCategory().equals(Biome.Category.NETHER))
//            && !(event.getCategory().equals(Biome.Category.THEEND))) {
//
//            GenerateOre(event.getGeneration());
////            event.getGeneration().addFeature(GenerationStage.Decoration.UNDERGROUND_ORES,
////                    Feature.ORE.configured(new OreFeatureConfig(ruleTest, blockState, veinSize))
...
//
//
//        private static void GenerateOre(BiomeGenerationSettingsBuilder generation) {
//
