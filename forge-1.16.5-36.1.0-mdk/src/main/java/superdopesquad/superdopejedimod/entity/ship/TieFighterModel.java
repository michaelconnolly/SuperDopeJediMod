...
@OnlyIn(Dist.CLIENT)
public class TieFighterModel<T extends Entity> extends ShipModel<T> {
...
//	public static final int TEXTURE_HEIGHT = 256;
   ...
   private static final float yoffset_begin = -88.0f;
    ...
    public TieFighterModel() {
    	...
    	this.renderers.add((buildCockpit()));

        // struts & wings.
        this.renderers.add(builStrut(false));
        this.renderers.add(builStrut(true));
        this.renderers.add(buildWing(absoluteDistanceFromCenter));
        this.renderers.add(buildWing(-absoluteDistanceFromCenter));
    }
//
//    @Override
...
//    }
    ...
    private ModelRenderer buildCockpit() {
    	...
    	mainpart.setTexSize(TEXTURE_WIDTH, TEXTURE_HEIGHT);
    ...
    private ModelRenderer buildWing(float absoluteDistanceFromCenter2) {
    	...
    	subwing.setTexSize(TEXTURE_WIDTH, TEXTURE_HEIGHT);
