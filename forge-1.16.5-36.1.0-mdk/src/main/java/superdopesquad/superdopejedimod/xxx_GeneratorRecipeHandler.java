...
//
//public final class GeneratorRecipeHandler
//{
...
//        if (GeneratorAddedRecipes.shouldAddRecipe(theItem))
//        {
//            return GeneratorAddedRecipes.getCraftingGrid(theItem);
//        }
//
//        // check all recipes for recipe for Itemstack
//        //List<?> listAllRecipes = CraftingManager.getRecipeList();
//        //List<?> listAllRecipes = CraftingManager.getRemainingItems(p_180303_0_, craftMatrix)();
//
...
////            {
////                resultItemStackArray[j] = shaped.recipeItems.toArray()[j];
////            }
////        }
//
...
////        }
//
////        if (SuperDopeJediMod.allowPartialDeconstructing)
////        {
