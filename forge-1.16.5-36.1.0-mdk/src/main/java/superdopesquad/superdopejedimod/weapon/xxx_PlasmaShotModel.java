...
//import superdopesquad.superdopejedimod.entity.critter.CritterModel;
//
//
//@OnlyIn(Dist.CLIENT)
////public class JawaModel extends ModelBiped {
//public class PlasmaShotModel<T extends Entity> extends CritterModel<T> {
//
//	 ModelRenderer head;
//	 ModelRenderer body;
//	 ModelRenderer arms;
...
//
//
//    public PlasmaShotModel(float scale, float p_i1164_2_, int width, int height) {
//
