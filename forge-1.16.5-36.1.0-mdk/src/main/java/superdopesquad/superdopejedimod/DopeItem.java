...
public class DopeItem extends Item  {
	...
	public DopeItem(String name) {
		...
		this(name, ItemGroup.TAB_MISC);
	}


	public DopeItem(String name, ItemGroup itemGroup) {

		this(name, new Item.Properties().tab(itemGroup));
	}


	public DopeItem(String name, Item.Properties properties) {
