...
*/
public class SphereBlueprint extends BuildingBlueprint {


	public SphereBlueprint(String name) {
		super(name);
	}
...
//	*/
//	public DomeBlueprint(String localName)
//	{
...
//	}
	...
	protected void build(World world, BlockPos pos) {
		...
		GeometryUtil.buildSphereDestructive(world, pos, 15, Blocks.CLAY.defaultBlockState());
	}
