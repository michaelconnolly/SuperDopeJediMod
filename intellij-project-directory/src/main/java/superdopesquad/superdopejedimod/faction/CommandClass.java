...
//
//	    	sender.sendMessage(new TextComponentString("You are a member of the " + className + " class."));
//	    	return;
//	    }
//
...
//	    		sender.sendMessage(new TextComponentString("Failed to clear your class."));
//	    		return;
//	    	}
//
...
//	    	sender.sendMessage(new TextComponentString("Congratulations! " + SuperDopeJediMod.classManager.getPlayerClassLongDescription(player)));
//
//	    	return;
//	    }
//
...
//	    	if (!classSetSuccessfully) {
//	    		sender.sendMessage(new TextComponentString("Failed to set your class."));
//	    		return;
//	    	}
//
//	    	//String outputClassName = SuperDopeJediMod.classManager.getPlayerClassName(player);
