...
public class StormtrooperEntity extends MonsterEntity  {
    ...
    public static class RenderFactory implements IRenderFactory<StormtrooperEntity> {

        @Override
        public EntityRenderer<? super StormtrooperEntity> createRenderFor(EntityRendererManager manager) {
    ...
    public static AttributeModifierMap.MutableAttribute func_234188_eI_() {
        ...
        return StormtrooperEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 10.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, (double) 0.2F);
    }
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        ...
        return StormtrooperEntity.func_233666_p_()
