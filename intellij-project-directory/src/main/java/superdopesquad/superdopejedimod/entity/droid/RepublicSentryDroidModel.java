...
//
//@OnlyIn(Dist.CLIENT)
//public class RepublicSentryDroidModel extends ModelBiped
//{
...
//
//
//    public RepublicSentryDroidModel(float scale) {
//
//    	this(scale, 0.0F, textureWidth, textureHeight);
//    }
//
//
//    public RepublicSentryDroidModel(float scale, float p_i1164_2_, int width, int height) {
//
